...
1. [Онлайн-читалка](/class-structure/2.1.1./);

Дополнительная задача со * :

2. [Учетная запись пользователя](/class-structure/2.1.2./);

Дополнительная задача со * :

3. [Считаем онлайн-пользователей](/class-structure/2.1.3./).

Для выполнения домашнего задания вы можете прочесть пример задачи, которая разбиралась на лекции:

4. [Режиссеры](/class-structure/2.1.4.).
