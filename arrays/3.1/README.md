Домашнее задание к занятию 3.1 Массивы одномерные
==
Необходимо выполнить и предоставить на проверку следующие задачи:

1. [Покупка товаров](/arrays/3.1/3.1.1./);

Дополнительная задача со *

2. [Сортировка массива вручную](/arrays/3.1/3.1.2./).

Условие задачи из лекции (для информации, ее не нужно выполнять и сдавать на проверку):

3. [Задача про информационное табло общественного транспорта](/arrays/3.1/3.1.3./)
