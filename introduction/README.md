Домашнее задание к занятию 1.1 Введение в программирование
==

Привет! 
Это первые задача на курсе Java (после каждой лекции будет 2 или 3 задачи для применения пройденного материала).

1) [Автор программы](/introduction/1.1.1/);

Дополнительная задача со * :

2) [Вычисление разности переменных](/introduction/1.1.2/);
