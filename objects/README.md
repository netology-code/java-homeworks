...
Менеджер Иван заводит задачу программисту и вводит в нашу программу следующий текст: Добавить картинку на главный экран приветствия, задача начинается в 15:00 и заканчивается в 19:30. 
