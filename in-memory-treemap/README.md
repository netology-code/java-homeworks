...
## Задача 2
Список ip-адресов.
Вы пишете программу сетевого администрирования ФСБ. Вам дан очень большой список случайных ip-адресов с соответствующими им адресами граждан. Нужно сгруппировать эти адреса по группам подсетей.

## Задача 3
Библиотека
Вы пишете программу учета книг в библиотеке по разделам.
Пользователь вводит название книги и раздел, к которому она относится- с консоли и в бесконечном цикле, пока не введет ключевое слово “end”. 
Программа группирует эти книги по структуре, где ключ- “название раздела”, а значение- список книг.
