...
[2.	Иерархия “Жанры книг”](./2.2.2); *(не обязательна к выполнению).

[3.	Иерархия “Автомобили”](./2.2.3) *(лекционная задача).

=======

Все задачи обязательны к выполнению для получения зачета, кроме задачи со `*`. Присылать на проверку можно каждую задачу по отдельности или все задачи вместе. Во время проверки по частям ваша домашняя работа будет со статусом "На доработке".
