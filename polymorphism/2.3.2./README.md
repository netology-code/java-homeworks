...
Бухгалтерская программа должна уметь проводить операции c различными агентами, как физическими/юридическими, так и с иностранными компаниями: чп, ип, ооо, зао, ~~иклмн~~, ~~ёпрст~~.
...
1. Создание нескольих счетов и рассчет налогов для них.
